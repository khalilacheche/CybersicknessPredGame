...
// Modified by Khalil Achache to use for drawing arc lines without the teleporting components
//
//=============================================================================
...
using UnityEngine;
    ...
    //-------------------------------------------------------------------------
    public class WaterArc : MonoBehaviour
    {
        ...
        void Update()
        {
            ...
            scale =  Valve.VR.InteractionSystem.Player.instance.transform.lossyScale.x;
        ...
        private float FindProjectileCollision(out RaycastHit hitInfo)
        {
            ...
            for (int i = 0; i < segmentCount; ++i)
            {
                ...
                if (Physics.Linecast(segmentStartPos, segmentEndPos, out hitInfo, LayerMask.GetMask("Level")))
                {
